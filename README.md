...
![dsh](https://img.shields.io/badge/dsh-plugin-web-4D6BFE) ![version](https://img.shields.io/badge/version-0.2.9-4D6BFE) ![license](https://img.shields.io/badge/license-MIT-green)
...
# https://gitee.com/coldcgh/dsh-deepseek-chat/releases/download/0.2.9/coldcgh-dsh-deepseek-chat-0.2.9.tgz
curl -L -o dsh-deepseek-chat.tgz https://gitee.com/coldcgh/dsh-deepseek-chat/releases/download/0.2.9/coldcgh-dsh-deepseek-chat-0.2.9.tgz
dsh plugin --profile web add ./dsh-deepseek-chat.tgz

# 方式三：从源码构建安装（开发测试）
cd dsh-deepseek-chat && npm pack
dsh plugin --profile web add ./coldcgh-dsh-deepseek-chat-0.2.9.tgz
```
