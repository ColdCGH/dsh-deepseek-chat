...
# https://gitee.com/coldcgh/deepseek-chat/releases/download/0.2.1/coldcgh-deepseek-chat-0.2.1.tgz
curl -L -o deepseek-chat.tgz https://gitee.com/coldcgh/deepseek-chat/releases/download/0.2.1/coldcgh-deepseek-chat-0.2.1.tgz
dsh plugin --profile web add ./deepseek-chat.tgz

# 方式二：从源码构建安装（开发测试）
cd deepseek-chat && npm pack
dsh plugin --profile web add ./coldcgh-deepseek-chat-0.2.1.tgz
```
