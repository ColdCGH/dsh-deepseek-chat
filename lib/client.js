...
function ensureEntryStyles() {
  ...
  st.textContent = [
    "#" + CHAT_ENTRY_ID + " a { transition: width 200ms ease, height 200ms ease, padding 200ms ease; }",
